...
public class ClienteEmpleadoController {
    ...
    public ClienteEmpleado getClienteEmpleadoById(@PathVariable Integer idEmpleado, @PathVariable Integer idCliente) {
        ClienteEmpleado clienteEmpleado = clienteEmpleadoRepository.findClienteEmpleadoByIds(idEmpleado, idCliente);
    ...
    public ResponseEntity<?> updateClienteEmpleado(@PathVariable int idEmpleado, @PathVariable int idCliente, @RequestBody ClienteEmpleado clienteEmpleado) {
